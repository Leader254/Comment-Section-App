    ...
    <div className="message">
      <div className="message-content">
        ...
        <div className="icons-and-time">
            ...
            <p style={{color:" #888"}} className="time">{message.timestamp}</p>
            </div>
        <div className="message-actions">
        <button className="reply-btn" onClick={() => setReplyingToReply(message.id)}>
        ...
        <button className="delete-btn2" onClick={() => handleDelete(message.id)}>
